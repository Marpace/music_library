...
// const newLibrary = addTrackToPlaylist("t03", "p01")
// console.log(newLibrary.playlists);

// console.log(addTrack("In The End", "Linking Park", "In The End"));

// console.log(addPlaylist("Roadtrip"))

// printSearchResults("ee");